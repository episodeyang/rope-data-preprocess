...
from path import project_dir, poke_data_dir
...
img_mean = np.load(open(project_dir + "data/img_mean.npy"))
...
TRAIN_DATA = "rope8/train"
TEST_DATA = "rope8/test"
...
def get_batch(source_name, batch_size = 1):
    ...
    for example, i in itertools.izip(SOURCES[source_name], xrange(batch_size)):
        ...
        Y3[i, :] = window.encode_length(length)[0]
    return X1, X2, Y1, Y2, Y3, S1, S2
